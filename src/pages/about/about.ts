...
export class AboutPage {
  fallCourses: FirebaseListObservable<any>;
  winterCourses: FirebaseListObservable<any>;

  constructor( public modalCtrl: ModalController, public navCtrl: NavController, public af: AngularFireDatabase) {     
    //this.initializeFall();
    //this.initializeWinter();
    this.fallCourses = af.list('fallcourses');
    this.winterCourses = af.list('wintercourses');
  }
